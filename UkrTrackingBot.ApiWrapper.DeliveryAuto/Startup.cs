...
namespace UkrTrackingBot.ApiWrapper.DeliveryAuto
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new Swashbuckle.AspNetCore.Swagger.Info { Title = "UkrTrackingBot.ApiWrapper.DeliveryAuto", Version = "v1" });
            });
        }
        ...
        private void ServicesRegistration(IServiceCollection services)
        {
            ...
            {
                var section = Configuration.GetSection("DeliveryAuto");
                var config = section.Get<Domain.Configuration.DeliveryConfiguration>();
                        ...
                        IApplicationLifetime appLifetime)
        {
            ...
            else
            {
                ...
                ExceptionlessClient.Default.Configuration.DefaultTags.Add("ApiWrapper.DeliveryAuto");
                  ...
                  .WriteTo
                    .Logger(lc =>
                        lc
                            ...
                            .WriteTo
                            .Exceptionless(b => b.AddTags("ApiWrapper.DeliveryAuto")))
                  .CreateLogger();
            }
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint(virtualPath + "/swagger/v1/swagger.json", "UkrTrackingBot.ApiWrapper.DeliveryAuto v1");
            });
        }
    }
}
